...
# parser.add_argument('--dataset',default='./FireDetection/Train')
# parser.add_argument('--dataset',default='./covid/Train')
# parser.add_argument('--dataset',default='./covid-others/Train')
parser.add_argument('--dataset',default='./fire-all/Train')
