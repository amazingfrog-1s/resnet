...
def resnet18(pretrained=False, model_path=None, num_classes=1000, **kwargs):
    ...
    if num_classes != 1000:
        ...
        model.fc = nn.Linear(in_features=inchann, out_features=num_classes, bias=True)
    return model
...
def create_model(arch, pretrained=False, model_path=None, num_classes=1000):
    ...
    model = get_model(pretrained=pretrained, model_path=model_path, num_classes=num_classes)
    return model
...
if __name__ == '__main__':
    ...
    resnet = create_model('res18', pretrained=True, model_path=model_path, num_classes=2)
    print(resnet.fc.weight)
    print(resnet.fc.weight.shape)
